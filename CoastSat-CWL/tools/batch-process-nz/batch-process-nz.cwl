...
inputs:
  script:
    ...
    default:
      class: File
      path: batch_process_nz_wrapper.py
...
requirements:
  ...
  InitialWorkDirRequirement:
    listing:
      - entry: $(inputs.script)
        entryname: batch_process_nz_wrapper.py

stdout: batch_process_nz_output.txt
